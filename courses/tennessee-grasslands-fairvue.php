      ...
      gtag('config', 'G-7VPNPCDTBP');
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/tennessee-grasslands-fairvue/${i}.webp')`;
            ...
            <div class="course-info-grid" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 2rem; margin-bottom: 4rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=981+Plantation+Boulevard,+Gallatin,+TN+37066" 
                            width="100%" 
                            height="200" 
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/tennessee-grasslands-fairvue/1.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/tennessee-grasslands-fairvue/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/tennessee-grasslands-fairvue/3.webp');"></div>
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Tennessee Grasslands - Fairvue - Complete Photo Gallery</h2>
