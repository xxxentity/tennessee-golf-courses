    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/harpeth-hills-golf-course/1.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/harpeth-hills-golf-course/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/harpeth-hills-golf-course/3.webp');"></div>
            </div>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/harpeth-hills-golf-course/${i}.webp')`;
                galleryItem.onclick = () => window.open(`../images/courses/harpeth-hills-golf-course/${i}.webp`, '_blank');
