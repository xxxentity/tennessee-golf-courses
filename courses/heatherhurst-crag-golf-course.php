...
$course_data = [
    ...
    'description' => '18-hole championship golf course in Fairfield Glade, TN. Designed by Gary Rogers Baird and completed in mid-2000. Features bentgrass tees and 6,171 yards from blue tees.',
...
<head>
    ...
    <style>
        .course-hero {
            height: 60vh;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/courses/heatherhurst-crag-golf-course/1.webp');
...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            <h1>Heatherhurst Crag Golf Course</h1>
        ...
        <div class="container">
            <div class="course-info-grid">
                <div class="course-info-card">
                    ...
                    <div class="course-specs single-column">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">6,171 (Blue Tees)</span>
                        </div>
                        <div class="spec-item">
                            <span class="spec-label">Course Rating:</span>
                            <span class="spec-value">68.6 (Blue Tees)</span>
                        </div>
                        <div class="spec-item">
                            <span class="spec-label">Slope Rating:</span>
                            <span class="spec-value">121 (Blue Tees)</span>
                        </div>
                        <div class="spec-item">
                            <span class="spec-label">Designer:</span>
                            <span class="spec-value">Gary Rogers Baird</span>
                        </div>
                        <div class="spec-item">
                ...
                <div class="course-info-card">
                    ...
                    Fairfield Glade<br>
                    Crossville, TN 38558</p>
                    
                    <p><strong>Phone:</strong><br>
                    (931) 456-2864</p>
                    
                    <p><strong>Website:</strong><br>
                    <a href="https://www.fairfieldglade.com/heatherhurst-crag" target="_blank" rel="noopener noreferrer" style="color: #4a7c59;">fairfieldglade.com</a></p>
                    
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=Heatherhurst+Crag+Golf+Course+Fairfield+Glade+TN&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                        ...
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=Heatherhurst+Crag+Golf+Course+Fairfield+Glade+TN" 
                               target="_blank" 
            ...
            <!-- Course Description -->
            <div class="course-info-card">
                <h3><i class="fas fa-golf-ball"></i> About Heatherhurst Crag Golf Course</h3>
                <p>Heatherhurst Crag Golf Course is a distinguished 18-hole championship course located within the prestigious Fairfield Glade resort community in Crossville, Tennessee. Designed by renowned golf course architect Gary Rogers Baird and completed in mid-2000, this semi-private facility represents the pinnacle of modern golf course design and construction in the Cumberland Mountains.</p>
                
                <br>
                
                <p>The course measures 6,171 yards from the blue tees with a par of 72, featuring a course rating of 68.6 and a slope rating of 121. This balanced design provides an engaging challenge for skilled golfers while remaining accessible to players of all abilities. The strategic layout incorporates multiple tee options, including bentgrass tees that provide excellent playing surfaces throughout the season.</p>
                
                <br>
                
                <p>As the companion course to The Brae Course within the Heatherhurst Golf Club complex, The Crag offers a distinctly different playing experience while maintaining the same high standards of course conditioning and design excellence. The course takes its name from the rugged terrain and dramatic elevation changes that characterize this area of the Cumberland Plateau.</p>
                
                <br>
                
                <p>Gary Rogers Baird's design philosophy is evident throughout the layout, with each hole carefully crafted to take advantage of the natural topography and scenic beauty of the surrounding landscape. The course features strategic bunkering, well-positioned water hazards, and undulating greens that reward precision and course management while punishing errant shots.</p>
                
                <br>
                
                <p>The bentgrass tees represent a significant investment in playing surface quality, providing consistent lies and excellent durability throughout the playing season. This attention to detail extends to every aspect of the course maintenance, ensuring that Heatherhurst Crag consistently delivers the premium playing conditions expected at a championship-caliber facility.</p>
                
                <br>
                
                <p>Located within the Fairfield Glade resort community, Heatherhurst Crag Golf Course benefits from its association with one of Tennessee's premier golf destinations. The course offers full tournament hosting capabilities and serves both the resort's guests and the broader golfing community, making it a cornerstone of the region's golf offerings since its opening over two decades ago.</p>
            </div>
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <img src="../images/courses/heatherhurst-crag-golf-course/2.webp" alt="Heatherhurst Crag Golf Course Fairfield Glade, TN - Championship 18-hole golf course fairway with manicured Bermuda grass designed by Gary Rogers Baird, Tennessee semi-private golf course" class="gallery-item">
                <img src="../images/courses/heatherhurst-crag-golf-course/3.webp" alt="Heatherhurst Crag Golf Course Fairfield Glade, TN - Pristine putting green with strategic bunkers and mature landscaping, Semi-Private 18-hole Tennessee golf course" class="gallery-item">
                <img src="../images/courses/heatherhurst-crag-golf-course/4.webp" alt="Heatherhurst Crag Golf Course Fairfield Glade, TN - Scenic golf course view featuring Gary Rogers Baird architectural design, premium Tennessee semi-private golf course" class="gallery-item">
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Heatherhurst Crag Golf Course - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Heatherhurst Crag Golf Course</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="heatherhurst-crag-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play Heatherhurst Crag Golf Course?</h2>
                <p>Book your tee time today at this championship course in Fairfield Glade, Tennessee</p>
                <div class="booking-buttons">
                    <a href="https://www.fairfieldglade.com/heatherhurst-crag" target="_blank" rel="noopener noreferrer" class="btn-book">Visit Course Website</a>
                    <a href="https://course.bluegolf.com/bluegolf/course/course/heatherhurstgccrag/index.htm" target="_blank" rel="noopener noreferrer" class="btn-contact">Book Tee Time</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Heatherhurst Crag Golf Course';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/heatherhurst-crag-golf-course/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/heatherhurst-crag-golf-course/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Heatherhurst Crag Golf Course
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('heatherhurst-crag-rating-stars');
            if (ratingContainer) {
    ...
    <script>
        // Initialize course-specific weather for Heatherhurst Crag Golf Course
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof initializeCourseWeather === 'function') {
                initializeCourseWeather('heatherhurst-crag-golf-course');
            }
        });
    </script>
</body>
