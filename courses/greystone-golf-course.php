...
<body>
    ...
    ">
        <div class="course-hero-content" style="max-width: 800px; padding: 2rem;">
            ...
            <p style="font-size: 1.3rem; margin-bottom: 2rem; opacity: 0.9;">Mark McCumber Design • Dickson, Tennessee</p>
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="pricing-section">
                        ...
                        <div class="pricing-note" style="font-style: italic; color: #666; font-size: 0.9rem; margin-top: 1rem;">
                            10-Time Host of Tennessee State Open • Championship Design
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../images/courses/greystone-golf-course/1.jpeg" alt="Greystone Golf Course Dickson, TN - Aerial view of championship 18-hole golf course showing signature holes and clubhouse facilities" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/greystone-golf-course/2.jpeg" alt="Greystone Golf Course Dickson TN - Panoramic fairway view hole 12 with strategic bunkers and mature trees" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/greystone-golf-course/3.jpeg" alt="Greystone Golf Course Tennessee - Championship golf course layout showing championship layout and natural terrain" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
            </div>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Greystone Golf Course';
                const location = 'Dickson, TN';
                const locationShort = 'Dickson TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/greystone-golf-course/${i}.jpeg" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
