    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Three Ridges Golf Course - Complete Photo Gallery</h2>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/three-ridges-golf-course/${i}.jpeg')`;
                galleryItem.onclick = () => window.open(`../images/courses/three-ridges-golf-course/${i}.jpeg`, '_blank');
