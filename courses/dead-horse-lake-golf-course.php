            ...
            <div class="course-info-grid">
                ...
                <div class="course-info-card">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=3016+Gravelly+Hills+Road,+Louisville,+TN+37777" 
                            width="100%" 
                            height="200" 
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/dead-horse-lake-golf-course/${i}.jpeg')`;
