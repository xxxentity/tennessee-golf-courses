...
$course_data = [
    ...
    'description' => '18-hole championship golf course in Fairfield Glade, TN. Part of Fairfield Glade resort at 2,000 feet elevation on Cumberland Plateau. Features 6,499 yards from blue tees.',
...
<head>
    ...
    <style>
        .course-hero {
            height: 60vh;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/courses/heatherhurst-brae-golf-course/1.webp');
...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            <h1>Heatherhurst Brae Golf Course</h1>
            <p>Resort Course • Fairfield Glade, Tennessee</p>
        ...
        <div class="container">
            <div class="course-info-grid">
                <div class="course-info-card">
                    ...
                    <div class="course-specs single-column">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">6,499 (Blue Tees)</span>
                        </div>
                        <div class="spec-item">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">123 (Blue Tees)</span>
                        </div>
                        <div class="spec-item">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">2,000 feet</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="course-info-card">
                    ...
                    <a href="https://www.fairfieldglade.com/heatherhurst-brae" target="_blank" rel="noopener noreferrer" style="color: #4a7c59;">fairfieldglade.com</a></p>
                    
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=Heatherhurst+Brae+Golf+Course+Fairfield+Glade+TN&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                        ...
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=Heatherhurst+Brae+Golf+Course+Fairfield+Glade+TN" 
                               target="_blank" 
            ...
            <!-- Course Description -->
            <div class="course-info-card">
                <h3><i class="fas fa-golf-ball"></i> About Heatherhurst Brae Golf Course</h3>
                <p>Heatherhurst Brae Golf Course is a distinguished 18-hole championship course located within the acclaimed Fairfield Glade resort community in Crossville, Tennessee. Positioned at an elevation of 2,000 feet on the scenic Cumberland Plateau, this resort course offers golfers a unique mountain golf experience with mild climate conditions and stunning natural wooded beauty.</p>
                
                <br>
                
                <p>The course stretches to 6,499 yards from the blue tees with a par of 72, featuring a course rating of 70.7 and a slope rating of 123. Multiple tee options accommodate golfers of all skill levels, with the white tees playing at 5,980 yards, yellow tees at 5,018 yards, and red tees offering a comfortable 4,667 yards for those seeking a more relaxed round.</p>
                
                <br>
                
                <p>As part of the Fairfield Glade resort, often referred to as the "Golf Capital of Tennessee," Heatherhurst Brae is one of five championship golf courses within the community. This distinction places it among Tennessee's premier golf destinations, offering resort-style golf in a mountain setting that combines challenging play with breathtaking scenery.</p>
                
                <br>
                
                <p>The course design takes full advantage of the Cumberland Plateau's natural terrain, incorporating the area's rolling topography and native hardwood forests to create a layout that is both visually stunning and strategically challenging. The elevation changes throughout the course provide dramatic vistas while adding an extra dimension to club selection and shot-making.</p>
                
                <br>
                
                <p>Located conveniently between Knoxville and Nashville, Heatherhurst Brae benefits from the Cumberland Plateau's unique climate, which offers cooler temperatures than the surrounding valleys during summer months, making it an ideal year-round golf destination. The course's mountain setting provides a refreshing escape from the heat while delivering consistently excellent playing conditions.</p>
                
                <br>
                
                <p>Beyond golf, the Fairfield Glade resort community offers an impressive array of amenities including 12 tennis courts, 11 lakes for fishing and water activities, extensive walking trails through the natural landscape, multiple restaurants, and swimming pools. This comprehensive resort experience makes Heatherhurst Brae not just a golf destination, but part of a complete recreational retreat in the heart of Tennessee's beautiful Cumberland Mountains.</p>
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Heatherhurst Brae Golf Course - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Heatherhurst Brae Golf Course</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="heatherhurst-brae-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play Heatherhurst Brae Golf Course?</h2>
                <p>Book your tee time today at this resort course in Fairfield Glade, Tennessee</p>
                <div class="booking-buttons">
                    <a href="https://www.fairfieldglade.com/heatherhurst-brae" target="_blank" rel="noopener noreferrer" class="btn-book">Visit Course Website</a>
                    <a href="https://course.bluegolf.com/bluegolf/course/course/heatherhurstthebrae/index.htm" target="_blank" rel="noopener noreferrer" class="btn-contact">Book Tee Time</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Heatherhurst Brae Golf Course';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/heatherhurst-brae-golf-course/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/heatherhurst-brae-golf-course/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Heatherhurst Brae Golf Course
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('heatherhurst-brae-rating-stars');
            if (ratingContainer) {
    ...
    <script>
        // Initialize course-specific weather for Heatherhurst Brae Golf Course
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof initializeCourseWeather === 'function') {
                initializeCourseWeather('heatherhurst-brae-golf-course');
            }
        });
    </script>
</body>
