...
<body>
    ...
    <section class="photo-gallery">
        <div class="container">
            <div class="section-header">
                ...
                <p>Explore TPC Southwind through stunning photography</p>
            </div>
            <div class="gallery-grid">
                <?php for ($i = 2; $i <= 45; $i++): ?>
                    <div class="gallery-item" onclick="openLightbox(<?php echo $i; ?>)">
                        <img src="../images/courses/tpc-southwind/<?php echo $i; ?>.jpeg" alt="TPC Southwind - Image <?php echo $i; ?>" loading="lazy">
    ...
    <div id="lightbox" class="lightbox">
        <div class="lightbox-content">
            ...
            <img id="lightbox-image" src="" alt="TPC Southwind Gallery">
    ...
    <script>
        ...
        function openLightbox(imageIndex) {
            ...
            lightboxImage.src = `../images/courses/tpc-southwind/${imageIndex}.jpeg`;
        ...
        function changeLightboxImage(direction) {
            ...
            lightboxImage.src = `../images/courses/tpc-southwind/${currentImageIndex}.jpeg`;
