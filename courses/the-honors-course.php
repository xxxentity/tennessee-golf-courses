...
<head>
    ...
    <title>The Honors Course - Tennessee Golf Courses</title>
    <meta name="description" content="The Honors Course - Pete Dye designed championship golf course in Ooltewah, TN. Private club honoring amateur golf with major USGA championship history.">
            ...
            <div class="course-info-grid" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 2rem; margin-bottom: 4rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=9603+Lee+Highway,+Ooltewah,+TN+37363" 
                            width="100%" 
                            height="200" 
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">The Honors Course - Complete Photo Gallery</h2>
