...
<head>
    ...
    <title>Lake Tansi Golf Course - Tennessee Golf Courses</title>
    <meta name="description" content="Lake Tansi Golf Course - Robert Renaud designed championship course in Crossville, TN. Ranked 9th in Tennessee by Golf Advisor with 6 tee options on 18 holes.">
            ...
            <div class="course-info-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 3rem; margin-bottom: 4rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=2476+Dunbar+Road,+Crossville,+TN+38572" 
                            width="100%" 
                            height="200" 
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/lake-tansi-golf-course/1.jpeg');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/lake-tansi-golf-course/2.jpeg');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/lake-tansi-golf-course/3.jpeg');"></div>
            </div>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/lake-tansi-golf-course/${i}.jpeg')`;
