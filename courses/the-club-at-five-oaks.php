...
$course_data = [
    ...
    'location' => 'Lebanon, TN',
    'description' => 'Neal Carson designed championship golf course in Lebanon, TN. 18-hole par-72 course featuring rolling hills, Zoysia fairways, and Bermuda greens on 500+ acres.',
    'image' => '/images/courses/the-club-at-five-oaks/1.webp',
    'holes' => 18,
    'par' => 72,
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">The Club at Five Oaks Gallery</h2>
    ...
    <script>
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'The Club at Five Oaks';
                const location = 'Lebanon, TN';
                const locationShort = 'Lebanon TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/the-club-at-five-oaks/${i}.jpeg" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
