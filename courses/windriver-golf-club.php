...
<head>
    ...
    <title>WindRiver Golf Club - Tennessee Golf Courses</title>
    <meta name="description" content="WindRiver Golf Club - Bob Cupp designed championship course overlooking Tellico Lake in Lenoir City, TN. Tennessee's first Audubon certified golf course.">
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">WindRiver Golf Club - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div style="text-align: center; margin-bottom: 3rem;">
                ...
                <p style="color: #666; font-size: 1.1rem;">Read reviews from members who have played WindRiver Golf Club</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="comment_text" name="comment_text" rows="4" placeholder="Share your experience at WindRiver Golf Club..." required></textarea>
                        </div>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/windriver-golf-club/${i}.webp')`;
                galleryItem.onclick = () => window.open(`../images/courses/windriver-golf-club/${i}.webp`, '_blank');
