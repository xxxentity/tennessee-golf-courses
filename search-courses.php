...
$courses = [
    ...
    ['name' => 'Franklin Bridge Golf Club', 'location' => 'Franklin, TN', 'slug' => 'forrest-crossing-golf-course'],
    ...
    ['name' => 'Heatherhurst Brae Golf Course', 'location' => 'Fairfield Glade, TN', 'slug' => 'heatherhurst-brae-golf-course'],
    ['name' => 'Heatherhurst Crag Golf Course', 'location' => 'Fairfield Glade, TN', 'slug' => 'heatherhurst-crag-golf-course'],
    ...
    ['name' => 'Old Fort Golf Course', 'location' => 'Murfreesboro, TN', 'slug' => 'old-fort-golf-course'],
    ...
    ['name' => 'The Links at Kahite', 'location' => 'Vonore, TN', 'slug' => 'the-links-at-kahite'],
    ['name' => 'The Links at Whitehaven', 'location' => 'Memphis, TN', 'slug' => 'the-links-at-whitehaven'],
    ['name' => 'Tanasi Golf Course', 'location' => 'Tellico Village/Loudon, TN', 'slug' => 'tanasi-golf-course'],
    ...
    ['name' => 'The Country Club', 'location' => 'Morristown, TN', 'slug' => 'the-country-club'],
    ...
    ['name' => 'WindRiver Golf Club', 'location' => 'Lenoir City, TN', 'slug' => 'windriver-golf-club'],
    ['name' => 'Windtree Golf Course', 'location' => 'Mount Juliet, TN', 'slug' => 'windtree-golf-course'],
    ['name' => 'Windyke Country Club', 'location' => 'Memphis, TN', 'slug' => 'windyke-country-club'],
    ...
    ['name' => 'Dorchester Golf Club', 'location' => 'Fairfield Glade, TN', 'slug' => 'dorchester-golf-club'],
