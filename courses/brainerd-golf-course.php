...
<body>
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/brainerd-golf-course/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brainerd-golf-course/3.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brainerd-golf-course/4.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brainerd-golf-course/5.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brainerd-golf-course/6.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brainerd-golf-course/7.webp');"></div>
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Brainerd Golf Course - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Brainerd Golf Course</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="brainerd-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play Brainerd Golf Course?</h2>
                <p>Book your tee time today and experience this historic Donald Ross design in Chattanooga</p>
                <div class="booking-buttons">
                    <a href="tel:+14238552692" class="btn-book">Book Tee Time</a>
                    <a href="tel:+14238552692" class="btn-contact">Contact Pro Shop</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/brainerd-golf-course/${i}.webp')`;
                galleryItem.onclick = () => window.open(`../images/courses/brainerd-golf-course/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Brainerd Golf Course
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('brainerd-rating-stars');
            if (ratingContainer) {
