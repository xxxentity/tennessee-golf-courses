...
<head>
    ...
    <style>
        .course-hero {
            height: 60vh;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/courses/chickasaw-country-club/1.webp');
...
<body>
    ...
    <section class="course-details">
        <div class="container">
            <div class="course-info-grid">
                <div class="course-info-card">
                    ...
                    <div class="course-specs single-column">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">6,720 yards</span>
                        </div>
                        <div class="spec-item">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">1924</span>
                        </div>
                        <div class="spec-item">
                ...
                <div class="course-info-card">
                    ...
                    <p style="text-align: center; color: #666; margin-top: 1rem;">
                        Chickasaw Country Club operates as a prestigious private country club serving Memphis families since 1922. 
                ...
                <div class="course-info-card">
                    ...
                    <a href="https://www.chickasawcc.com" target="_blank" rel="noopener noreferrer" style="color: #4a7c59;">chickasawcc.com</a></p>
                    
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=3395+Galloway+Ave,+Memphis,+TN+38122&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                            ...
                            title="Chickasaw Country Club Location">
                        </iframe>
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=3395+Galloway+Ave,+Memphis,+TN+38122" 
                               target="_blank" 
            ...
            <!-- Course Description -->
            <div class="course-info-card">
                <h3><i class="fas fa-golf-ball"></i> About Chickasaw Country Club</h3>
                
                <p>Chickasaw Country Club stands as one of Memphis's most distinguished private golf clubs, representing over a century of tradition and excellence. Founded in 1922, this prestigious club opened its championship course in 1924 with an original design by renowned golf course architect William Langford, establishing itself as a cornerstone of Memphis golf society.</p>
                ...
                <p>Chickasaw Country Club holds a unique place in professional golf history as the site where Byron Nelson's legendary 11-tournament winning streak came to an end during the 1945 Memphis Invitational PGA Tournament. Amateur Fred Haas won the tournament by five strokes, with Nelson finishing tied for fourth place, marking one of the most significant moments in PGA Tour history and cementing the club's legacy in golf's greatest unbreakable records.</p>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Chickasaw Country Club - Complete Photo Gallery</h2>
                <button class="close" onclick="closeGallery()">&times;</button>
            </div>
            <div class="full-gallery-grid">
                <?php for ($i = 1; $i <= 25; $i++): ?>
                    <div class="full-gallery-item" style="background-image: url('../images/courses/chickasaw-country-club/<?php echo $i; ?>.webp');"></div>
                <?php endfor; ?>
            </div>
        </div>
    </div>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://tennesseegolfcourses.com/courses/chickasaw-country-club'); ?>" target="_blank" class="share-button facebook" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #1877f2; color: white;">
                        <i class="fab fa-facebook-f"></i> Share on Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out Chickasaw Country Club'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/chickasaw-country-club'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out Chickasaw Country Club'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/chickasaw-country-club'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Chickasaw Country Club</p>
            </div>
                ...
                <div class="review-form">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="comment_text" id="comment_text" placeholder="Share your experience at Chickasaw Country Club..." required></textarea>
                        </div>
            ...
            <?php else: ?>
                <div class="login-prompt">
                    <p>Please log in to leave a review of Chickasaw Country Club.</p>
