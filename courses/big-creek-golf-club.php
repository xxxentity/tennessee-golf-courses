...
<body>
    ...
    <section class="course-hero">
        ...
        <div class="course-hero-content">
            <h1>Big Creek Golf Club</h1>
            <p>B.G. Mitchell Design • Millington, Tennessee (1976-Closed)</p>
            <div class="hero-stats">
                ...
                <div class="hero-stat">
                    ...
                    <span>Millington, TN</span>
                </div>
                <div class="hero-stat">
                    <i class="fas fa-calendar-alt"></i>
                    <span>1976-Closed</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="course-info-section">
        <div class="container">
            ...
            <div class="closure-alert">
                ...
                <p><strong>Big Creek Golf Club is permanently closed.</strong> This page is maintained for historical reference and for those searching for information about this former Tennessee golf course.</p>
        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../images/courses/big-creek-golf-club/2.jpeg" alt="Big Creek Golf Club Millington TN - Panoramic fairway view hole 12 with strategic bunkers and mature trees" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/big-creek-golf-club/3.jpeg" alt="Big Creek Golf Club Tennessee - Championship golf course layout showing championship layout and natural terrain" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/big-creek-golf-club/4.jpeg" alt="Big Creek Golf Club Millington TN - Championship golf course entrance with professional landscaping and signage" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
            </div>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://tennesseegolfcourses.com/courses/big-creek-golf-club'); ?>" target="_blank" class="share-button facebook" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #1877f2; color: white;">
                        <i class="fab fa-facebook-f"></i> Share on Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out Big Creek Golf Club in Millington, Tennessee'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/big-creek-golf-club'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out Big Creek Golf Club'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/big-creek-golf-club'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Did you play Big Creek Golf Club? Share your memories and experiences</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="comment_text" name="comment_text" rows="4" placeholder="Share your memories of playing at Big Creek Golf Club..." required></textarea>
                        </div>
            ...
            <div class="comments-container">
                <?php if (empty($comments)): ?>
                    <div class="comment-card">
                        <p style="text-align: center; color: #666;">No memories shared yet. Be the first to share your experience at Big Creek Golf Club!</p>
                    </div>
                <?php else: ?>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Big Creek Golf Club';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/big-creek-golf-club/${i}.jpeg" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
