    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Willow Creek Golf Club Photo Gallery</h2>
                <button class="close" onclick="closeGallery()">&times;</button>
            </div>
            <div class="full-gallery-grid">
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/1.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/2.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/3.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/4.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/5.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/6.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/7.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/8.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/9.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/10.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/11.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/12.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/13.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/14.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/15.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/16.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/17.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/18.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/19.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/20.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/21.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/22.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/23.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/24.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/willow-creek-golf-club/25.jpeg');"></div>
            </div>
        </div>
    </div>
