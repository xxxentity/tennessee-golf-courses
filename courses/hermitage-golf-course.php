...
<body>
    ...
    <section class="course-hero" style="
        height: 60vh; 
        background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('../images/courses/hermitage-golf-course/1.jpeg'); 
        background-size: cover; 
        background-position: center; 
        display: flex; 
        align-items: center; 
    ...
    ">
        <div class="course-hero-content" style="max-width: 800px; padding: 2rem;">
            ...
            <p style="font-size: 1.3rem; margin-bottom: 2rem; opacity: 0.9;">Two Championship Courses • Old Hickory, Tennessee</p>
    ...
    <section class="course-details" style="padding: 4rem 0;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-specs single-column" style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">Courses:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">Two 18-Hole</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">President's Reserve:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">7,200 yards, Par 72</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">General's Retreat:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">6,773 yards, Par 72</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">Opened:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">1986 & 2000</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">Tournament Host:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">LPGA Sara Lee Classic</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                    ...
                    <div class="pricing-section">
                        <div class="pricing-grid" style="display: grid; gap: 1.5rem;">
                            <div class="pricing-category" style="background: #f8f9fa; padding: 1.5rem; border-radius: 10px; border-left: 4px solid #2c5234;">
                                <h4 style="color: #2c5234; margin-bottom: 1rem; font-size: 1.1rem; font-weight: 600;">President's Reserve</h4>
                                ...
                                <div class="pricing-item" style="display: flex; justify-content: space-between; padding: 0.3rem 0; border-bottom: 1px solid #e5e7eb;">
                                    <span>Golf Digest Top 10</span>
                                    <span>Tennessee</span>
                                </div>
                                <div class="pricing-item" style="display: flex; justify-content: space-between; padding: 0.3rem 0;">
                                    <span>Denis Griffiths Design</span>
                                    <span>2000</span>
                                </div>
                            </div>
                            
                            <div class="pricing-category" style="background: #f8f9fa; padding: 1.5rem; border-radius: 10px; border-left: 4px solid #2c5234;">
                                <h4 style="color: #2c5234; margin-bottom: 1rem; font-size: 1.1rem; font-weight: 600;">General's Retreat</h4>
                                <div class="pricing-item" style="display: flex; justify-content: space-between; padding: 0.3rem 0; border-bottom: 1px solid #e5e7eb;">
                                    <span>18 Holes w/ Cart</span>
                                    <span>$65-85</span>
                                </div>
                                <div class="pricing-item" style="display: flex; justify-content: space-between; padding: 0.3rem 0; border-bottom: 1px solid #e5e7eb;">
                                    <span>LPGA Tournament</span>
                                    <span>1988-1999</span>
                                </div>
                                <div class="pricing-item" style="display: flex; justify-content: space-between; padding: 0.3rem 0;">
                                    <span>Gary Roger Baird</span>
                                    <span>Design</span>
                                </div>
                            </div>
                        </div>
                        <div class="pricing-note" style="font-style: italic; color: #666; font-size: 0.9rem; margin-top: 1rem;">
                            Nashville's Premier Dual-Course Public Golf Facility
                        </div>
                    </div>
                </div>
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-specs single-column" style="display: grid; grid-template-columns: 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">3939 Old Hickory Blvd</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">City:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">Old Hickory, TN 37138</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">Phone:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">(615) 847-4001</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            <span class="spec-label" style="font-weight: 600; color: #666;">Website:</span>
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;"><a href="https://www.hermitagegolf.com" target="_blank" style="color: #2c5234;">Visit Site</a></span>
                        </div>
                    </div>
            ...
            <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); margin-bottom: 4rem;">
                ...
                <p>Hermitage Golf Course stands as Nashville's premier dual-course public golf facility, offering two distinctly different championship experiences that have earned recognition throughout the Southeast. Located just 30 minutes from downtown Nashville along the scenic Cumberland River in Old Hickory, this award-winning facility provides golfers with an unmatched variety of challenges and playing experiences.</p>
                
                <br>
                
                <p>The flagship President's Reserve, designed by Denis Griffiths in 2000, has earned Golf Digest recognition as one of the "Top 10 in Tennessee." This challenging 7,200-yard championship layout winds through 300 acres of pristine Tennessee wetlands along the Cumberland River, featuring bentgrass greens and zoysia fairways that provide exceptional playing conditions year-round. The course's signature 15th hole features a stunning island green that ranks among Tennessee's most memorable par-3s.</p>
                
                <br>
                
                <p>The historic General's Retreat, designed by Gary Roger Baird in 1986, carries an impressive tournament pedigree as the former host of the LPGA Sara Lee Classic from 1988 to 1999. World Golf Hall of Fame members Nancy Lopez, Meg Mallon, and Laura Davies all claimed victories on this 6,773-yard championship layout. The course was voted "Best Golf Course in Nashville" and features four challenging par-5s, three offering exciting risk-reward opportunities over water.</p>
                
                <br>
                
                <p>With its combination of two championship courses, rich tournament history, and stunning Cumberland River setting, Hermitage Golf Course provides Nashville area golfers with an unparalleled public golf experience. Whether challenging yourself on the Golf Digest-recognized President's Reserve or playing where LPGA legends made history on General's Retreat, Hermitage delivers championship golf at its finest in Middle Tennessee.</p>
            </div>
        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../images/courses/hermitage-golf-course/1.jpeg" alt="Hermitage Golf Course Old Hickory, TN - Aerial view of championship 18-hole golf course showing signature holes and clubhouse facilities" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/hermitage-golf-course/2.jpeg" alt="Hermitage Golf Course Old Hickory TN - Panoramic fairway view hole 12 with strategic bunkers and mature trees" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/hermitage-golf-course/3.jpeg" alt="Hermitage Golf Course Tennessee - Championship golf course layout showing championship layout and natural terrain" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
            </div>
                ...
                <div class="comment-form-container" style="background: white; padding: 2rem; border-radius: 15px; margin-bottom: 3rem; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                    ...
                    <form method="POST" class="comment-form">
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            ...
                            <textarea name="comment_text" id="comment_text" rows="4" style="width: 100%; padding: 0.75rem; border: 2px solid #e2e8f0; border-radius: 8px; resize: vertical;" placeholder="Share your experience at Hermitage Golf Course..." required></textarea>
                        </div>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Hermitage Golf Course';
                const location = 'Old Hickory, TN';
                const locationShort = 'Old Hickory TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/hermitage-golf-course/${i}.jpeg" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
