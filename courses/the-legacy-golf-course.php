...
$course_data = [
    ...
    'description' => 'Raymond Floyd designed championship course in Springfield, TN. Ranked #2 public course in Tennessee with pristine bentgrass greens and rolling hills.',
    'image' => '/images/courses/the-legacy-golf-course/1.webp',
    'holes' => 18,
    'par' => 72,
    ...
    <section class="photo-gallery">
        <div class="container">
            <div class="section-header">
                ...
                <p>Experience the beauty of The Legacy Golf Course</p>
            </div>
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../images/courses/the-legacy-golf-course/1.jpeg" alt="The Legacy Golf Course Springfield, TN - Aerial view of championship 18-hole golf course showing signature holes and clubhouse facilities" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/the-legacy-golf-course/2.jpeg" alt="The Legacy Golf Course Springfield TN - Panoramic fairway view hole 12 with strategic bunkers and mature trees" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/the-legacy-golf-course/3.jpeg" alt="The Legacy Golf Course Tennessee - Championship golf course layout showing championship layout and natural terrain" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
            </div>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out The Legacy Golf Course in Springfield, Tennessee'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/the-legacy-golf-course'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out The Legacy Golf Course'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/the-legacy-golf-course'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">The Legacy Golf Course - Complete Photo Gallery</h2>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'The Legacy Golf Course';
                const location = 'Springfield, TN';
                const locationShort = 'Springfield TN';
                ...
                if (imageIndex <= 5) {
                    ...
                    const overviewTexts = [
                        ...
                        `${courseName} Tennessee - Championship golf course layout showing rolling hills and natural terrain`,
                        `${courseName} ${locationShort} - Championship golf course entrance with professional landscaping and signage`,
                        `${courseName} ${location} - Golf course overview showing scenic Tennessee hills and championship facilities`
                    ];
                    ...
                    const signatures = [
                        ...
                        `${courseName} ${location} - Signature hole ${holeNum} featuring Raymond Floyd design and natural beauty`,
                    ...
                    const amenities = [
                        ...
                        'Legacy Grill dining room with scenic Tennessee views',
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/the-legacy-golf-course/${i}.jpeg" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/the-legacy-golf-course/${i}.jpeg`, '_blank');
