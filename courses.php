...
$courses_static = [
    ...
    [
        ...
        'image' => '/images/courses/cumberland-cove-golf-course/1.webp',
    ...
    [
        ...
        'region' => 'Nashville Area',
        'description' => 'John LaFoy designed championship course from 1991. Semi-private course that served the Mount Juliet community for 27 years. PERMANENTLY CLOSED 2017 - preserved for historical reference.',
...
<body>
    ...
    <div id="courseModal" class="course-modal">
        <div class="course-modal-content">
            <div class="modal-header">
                <h2>Submit a Missing Course</h2>
                <span class="close-modal" onclick="closeCourseModal()">&times;</span>
            </div>
            
            <form id="courseSubmissionForm" class="course-form">
                ...
                <button type="submit" class="form-submit-btn">
                    <i class="fas fa-paper-plane"></i> Submit Course
                </button>
                
                <div class="form-info">
                    <i class="fas fa-info-circle"></i> We'll review your submission and add the course to our directory. Thank you for helping us improve!
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function closeCourseModal() {
            ...
            document.getElementById('courseSubmissionForm').reset();
        }
        ...
        document.getElementById('courseSubmissionForm').addEventListener('submit', function(e) {
            e.preventDefault();
