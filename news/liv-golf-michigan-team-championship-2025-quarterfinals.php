...
$article_title = 'Liv Golf Michigan Team Championship 2025 Quarterfinals';
?>
            ...
            <?php if ($is_logged_in): ?>
                <div class="comment-form">
                    ...
                    <form method="POST" action="">
                        <textarea name="comment_text" class="comment-textarea" placeholder="Share your thoughts on today's LIV Golf action..." required></textarea>
