            ...
            <div class="course-info-grid" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 2rem; margin-bottom: 4rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=235+Harbour+Greens+Place,+Sparta,+TN+38583" 
                            width="100%" 
                            height="200" 
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/honky-tonk-national-golf-course/1.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/honky-tonk-national-golf-course/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/honky-tonk-national-golf-course/3.webp');"></div>
            </div>
