...
<head>
    ...
    <style>
        .course-hero {
            height: 60vh;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/courses/overton-park-9/1.webp');
...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            <h1>Overton Park 9</h1>
            <p>King Collins Design • Memphis, Tennessee</p>
    ...
    <section class="course-details">
        <div class="container">
            <div class="course-info-grid">
                <div class="course-info-card">
                    ...
                    <div class="course-specs single-column">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">2,275</span>
                        </div>
                        <div class="spec-item">
                            <span class="spec-label">Designer:</span>
                            <span class="spec-value">King Collins</span>
                        </div>
                        <div class="spec-item">
                            <span class="spec-label">Opened:</span>
                            <span class="spec-value">1906</span>
                        </div>
                        <div class="spec-item">
                ...
                <div class="course-info-card">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <h4 style="color: #2c5234; margin-bottom: 0.5rem;">Adults (18-61)</h4>
                        <div class="course-specs">
                            <div class="spec-item">
                                <span class="spec-label">Weekdays:</span>
                                <span class="spec-value">$12</span>
                            </div>
                            <div class="spec-item">
                                <span class="spec-label">Weekends:</span>
                                <span class="spec-value">$15</span>
                            </div>
                        </div>
                    </div>
                    <div style="margin-bottom: 1.5rem;">
                        <h4 style="color: #2c5234; margin-bottom: 0.5rem;">Juniors (17 & Under)</h4>
                        <div class="course-specs">
                            <div class="spec-item">
                                <span class="spec-label">Weekdays:</span>
                    ...
                    <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #e5e7eb;">
                        ...
                        <div class="course-specs">
                            <div class="spec-item">
                                <span class="spec-label">Seniors (62+):</span>
                                <span class="spec-value">$10</span>
                            </div>
                            <div class="spec-item">
                                <span class="spec-label">Push Cart:</span>
                                <span class="spec-value">$4</span>
                            </div>
                            <div class="spec-item">
                                <span class="spec-label">Riding Cart:</span>
                                <span class="spec-value">$10/person</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="course-info-card">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=2080+Poplar+Ave,+Memphis,+TN+38104&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                            ...
                            title="Overton Park 9 Golf Course Location">
                        </iframe>
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=2080+Poplar+Ave,+Memphis,+TN+38104" 
                               target="_blank" 
            ...
            <!-- Course Description -->
            <div class="course-info-card">
                <h3><i class="fas fa-golf-ball"></i> About Overton Park 9</h3>
                <p>Overton Park 9 represents one of America's most unique municipal golf experiences, combining over a century of golf history with innovative modern design. Originally established in 1906, this historic 9-hole course has been completely reimagined by the acclaimed King Collins golf architecture firm, creating a distinctive layout that weaves through Overton Park's majestic old growth forest in the heart of Memphis.</p>
                
                <br>
                
                <p>The course stretches 2,275 yards with a par of 34, featuring three distinct tee options - Sky, Forest, and Wildflower - that accommodate golfers of all skill levels. What sets Overton Park 9 apart is its extraordinary setting within a historic urban forest, where golfers experience the rare opportunity to play among towering trees and native landscapes that have been preserved for generations.</p>
                
                <br>
                
                <p>King Collins' redesign incorporates over 10 acres of native grasses and creates vital habitat for diverse bird species, making each round both a golf experience and a nature encounter. The layout features distinctive design elements including two-tiered greens, hidden swales and landforms, challenging green complexes, and strategic bunker placements that reward thoughtful play.</p>
                
                <br>
                
                <p>Notable holes include the opening 290-yard Par 4 with its curving two-tiered green, the narrow tree-lined 135-yard Par 3 second hole, and the signature fifth hole featuring a "Punch Bowl" green with a challenging "X-Box" fairway feature. The longest hole, number eight at 320 yards, includes the memorable "Heartbreak Hotel" bunker that adds both character and challenge to the experience.</p>
                
                <br>
                
                <p>Operated jointly by Memphis Parks and the Overton Park Conservancy, this course embodies the "Golf for all" philosophy with incredibly affordable rates - including free junior golf on weekdays. The facility serves as both a municipal amenity and a conservation showcase, proving that exceptional golf design can coexist harmoniously with environmental stewardship and community accessibility.</p>
            </div>
            ...
            <div class="course-info-card">
                ...
                <div class="amenities-grid">
                    <div class="amenity-item">
                        ...
                        <span>Historic Forest Setting</span>
                    </div>
                    <div class="amenity-item">
                    ...
                    <div class="amenity-item">
                        ...
                        <span>Abe Goodman Clubhouse</span>
                    </div>
                    <div class="amenity-item">
                    ...
                    <div class="amenity-item">
                        ...
                        <span>Junior Golf Programs</span>
                    </div>
                    <div class="amenity-item">
                    ...
                    <div class="amenity-item">
                        ...
                        <span>Native Grass Areas</span>
                    </div>
                    <div class="amenity-item">
                        <i class="fas fa-dove"></i>
                        <span>Wildlife Habitat</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="photo-gallery">
        <div class="container">
            <div class="section-header">
                ...
                <p>Experience the unique beauty of golf in Memphis' historic forest</p>
            </div>
            <div class="gallery-grid">
                ...
                <div class="gallery-item">
                    <img src="../images/courses/overton-park-9/4.webp" alt="Overton Park 9 Memphis TN - Championship golf course entrance with professional landscaping and signage" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Overton Park 9 - Complete Photo Gallery</h2>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://tennesseegolfcourses.com/courses/overton-park-9'); ?>" target="_blank" class="share-button facebook" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #1877f2; color: white;">
                        <i class="fab fa-facebook-f"></i> Share on Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out Overton Park 9 in Memphis, Tennessee'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/overton-park-9'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out Overton Park 9'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/overton-park-9'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Overton Park 9</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="overton-park-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play Overton Park 9?</h2>
                <p>Book your tee time today and experience Memphis' most unique golf course</p>
                <div class="booking-buttons">
                    <a href="tel:9013052604" class="btn-book">Call Pro Shop</a>
                    <a href="https://www.overtonpark9.org" target="_blank" class="btn-contact">Visit Website</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Overton Park 9';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/overton-park-9/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/overton-park-9/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Overton Park 9
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('overton-park-rating-stars');
            if (ratingContainer) {
