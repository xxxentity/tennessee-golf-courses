...
<body>
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/ross-creek-landing-golf-course/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/ross-creek-landing-golf-course/3.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/ross-creek-landing-golf-course/4.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/ross-creek-landing-golf-course/5.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/ross-creek-landing-golf-course/6.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/ross-creek-landing-golf-course/7.webp');"></div>
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Ross Creek Landing Golf Course - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Ross Creek Landing</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="ross-creek-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play Ross Creek Landing?</h2>
                <p>Book your tee time today and experience a true Jack Nicklaus Signature Design</p>
                <div class="booking-buttons">
                    <a href="tel:9316763174" class="btn-book">Call Pro Shop</a>
                    <a href="https://www.golfatrosscreek.com" target="_blank" class="btn-contact">Visit Website</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/ross-creek-landing-golf-course/${i}.webp')`;
                galleryItem.onclick = () => window.open(`../images/courses/ross-creek-landing-golf-course/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Ross Creek Landing
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('ross-creek-rating-stars');
            if (ratingContainer) {
