...
$course_data = [
    ...
    'description' => 'Jack Nicklaus Signature Design golf course in Winchester, TN. Award-winning links-style course on Tims Ford Lake with 6,764-yard championship layout.',
...
<head>
    ...
    <style>
        .course-hero {
            height: 60vh;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/courses/bear-trace-at-tims-ford/1.webp');
...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            <h1>Bear Trace at Tims Ford</h1>
            <p>Jack Nicklaus Signature Design • Winchester, Tennessee</p>
        ...
        <div class="container">
            <div class="course-info-grid">
                <div class="course-info-card">
                    ...
                    <div class="course-specs single-column">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">6,763 (Gold Tees)</span>
                        </div>
                        <div class="spec-item">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <div class="course-specs">
                            ...
                            <div class="spec-item">
                                ...
                                <span class="spec-value">$57 + tax</span>
                            </div>
                            <div class="spec-item">
                ...
                <div class="course-info-card">
                    ...
                    570 Bear Trace Drive<br>
                    Winchester, TN 37398</p>
                    
                    <p><strong>Phone:</strong><br>
                    (931) 962-4653</p>
                    
                    <p><strong>Website:</strong><br>
                    <a href="https://tnstateparks.com/golf/course/bear-trace-at-tims-ford/" target="_blank" rel="noopener noreferrer" style="color: #4a7c59;">tnstateparks.com</a></p>
                    
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=570+Bear+Trace+Drive,+Winchester,+TN+37398&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                            ...
                            title="Bear Trace at Tims Ford Golf Course Location">
                        </iframe>
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=570+Bear+Trace+Drive,+Winchester,+TN+37398" 
                               target="_blank" 
            ...
            <div class="course-info-card">
                ...
                <p>Bear Trace at Tims Ford is a distinguished Jack Nicklaus Signature Design golf course that opened in 1999 in Winchester, Tennessee. Situated on a scenic peninsula formed by Tims Ford Lake, this award-winning course represents one of the Golden Bear's most innovative designs in the southeastern United States.</p>
                ...
                <p>The course design masterfully transitions from rolling former pastureland on the opening holes to wooded areas dominated by giant oak trees. This diverse terrain creates multiple "looks" throughout the round, keeping golfers engaged while providing varying strategic challenges that showcase Nicklaus's design philosophy of risk-reward golf.</p>
                
                <br>
                
                <p>Recognition came quickly after opening, with Bear Trace at Tims Ford earning prestigious awards including "Top Ten Places You Can Play" and "Best New Destination" in Tennessee for 1999. The back nine provides a particularly challenging test, culminating with the demanding 18th hole—a 453-yard par-four featuring strategic bunkers and the lake shoreline.</p>
                
                <br>
                
                <p>As part of the Tennessee Golf Trail and Bear Trace collection, the course represents Jack Nicklaus's commitment to providing quality public golf. The Golden Bear himself noted, "The idea of providing quality golf to residents and visitors of Tennessee is a wonderful concept," and Bear Trace at Tims Ford exemplifies this vision with its exceptional balance of challenge and playability.</p>
                
                <br>
                
                <p>Located within <a href="https://tnstateparks.com/parks/tims-ford" target="_blank" rel="noopener noreferrer" style="color: #4a7c59; font-weight: 600;">Tims Ford State Park</a>, the course offers families additional recreational opportunities beyond golf. The state park features camping, hiking trails, swimming areas, boat launches, and fishing on Tims Ford Lake, making it an ideal destination for golf trips where the entire family can enjoy outdoor activities while golfers experience this world-class Nicklaus design.</p>
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Bear Trace at Tims Ford - Complete Photo Gallery</h2>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://tennesseegolfcourses.com/courses/bear-trace-at-tims-ford'); ?>" target="_blank" class="share-button facebook" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #1877f2; color: white;">
                        <i class="fab fa-facebook-f"></i> Share on Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out Bear Trace at Tims Ford'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/bear-trace-at-tims-ford'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out Bear Trace at Tims Ford'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/bear-trace-at-tims-ford'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Bear Trace at Tims Ford</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="tims-ford-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play Bear Trace at Tims Ford?</h2>
                <p>Book your tee time today and experience this award-winning Jack Nicklaus design on Tims Ford Lake</p>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Bear Trace at Tims Ford';
                const location = 'Winchester, TN';
                const locationShort = 'Winchester TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/bear-trace-at-tims-ford/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/bear-trace-at-tims-ford/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Bear Trace at Tims Ford
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('tims-ford-rating-stars');
            if (ratingContainer) {
