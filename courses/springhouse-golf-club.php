...
<head>
    ...
    <style>
        .course-hero {
            height: 60vh;
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('../images/courses/springhouse-golf-club/1.jpeg');
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                ...
                <div class="gallery-item" style="background-image: url('../images/courses/springhouse-golf-club/5.jpeg');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/springhouse-golf-club/6.jpeg');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/springhouse-golf-club/7.jpeg');"></div>
            </div>
