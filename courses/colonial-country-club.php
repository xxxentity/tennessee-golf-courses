      ...
      gtag('config', 'G-7VPNPCDTBP');
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Colonial Country Club';
                const location = 'Cordova, TN';
                const locationShort = 'Cordova TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/colonial-country-club/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/colonial-country-club/${i}.webp`, '_blank');
...
<body>
    ...
    ">
        <div class="course-hero-content" style="max-width: 800px; padding: 2rem;">
            ...
            <p style="font-size: 1.3rem; margin-bottom: 2rem; opacity: 0.9;">Championship Golf • Cordova, Tennessee</p>
    ...
    <section class="course-details" style="padding: 4rem 0;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="course-info-grid" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 2rem; margin-bottom: 4rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-specs single-column" style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
                        ...
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">7,334</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <p style="text-align: center; color: #666; margin-top: 1rem;">
                        Colonial Country Club is among the premier private clubs in the Mid-South region with a proud 100+ year history. 
            ...
            <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); margin-bottom: 4rem;">
                ...
                <p>Colonial Country Club stands as one of the premier private clubs in the Mid-South region, boasting a proud 100+ year history that has established it among Tennessee's most distinguished golf destinations. Rated as high as the #4 golf course in the state of Tennessee by Golf Digest, this championship layout has hosted over 30 PGA Tour events throughout its storied history, welcoming legendary champions including Jack Nicklaus, Lee Trevino, and Gary Player to compete on its challenging and meticulously maintained fairways.</p>
                
                <br>
                
                <p>The championship South Course stretches an impressive 7,334 yards from the championship black tees with a demanding par 72 design that features a challenging course rating of 75.3 and slope rating of 138. With ten different tee options ranging from 4,603 to 7,334 yards, Colonial accommodates golfers of all skill levels while maintaining the strategic depth and championship caliber that has made it a favorite venue for professional tournaments and discerning members alike.</p>
                
                <br>
                
                <p>The course's design emphasizes both strategic shot-making and precision, with thoughtfully placed hazards, undulating greens, and mature landscaping that create a beautiful yet challenging test of golf. Each hole presents unique strategic options that reward creative thinking and precise execution, while the varied topography and hole layouts ensure that players remain engaged throughout their entire round on this tournament-tested championship course.</p>
                
                <br>
                
                <p>Beyond its world-class golf offering, Colonial Country Club provides a comprehensive private club experience with exceptional amenities including tennis courts, a state-of-the-art fitness center, swimming pool with food and beverage service, and multiple dining venues that range from casual to fine dining. The exquisite clubhouse serves as the heart of club life, offering members and their families a picturesque setting for socializing, dining, and pursuing personal interests in an atmosphere of Southern hospitality and refined elegance that has defined Colonial's character for over a century.</p>
            </div>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://tennesseegolfcourses.com/courses/colonial-country-club'); ?>" target="_blank" class="share-button facebook" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #1877f2; color: white;">
                        <i class="fab fa-facebook-f"></i> Share on Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out Colonial Country Club'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/colonial-country-club'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out Colonial Country Club'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/colonial-country-club'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
                    ...
                    <form method="POST" action="">
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            ...
                            <textarea name="comment_text" id="comment_text" rows="4" required 
                                      ...
                                      placeholder="Share your experience playing at Colonial Country Club..."></textarea>
                        </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Colonial Country Club - Complete Photo Gallery</h2>
