...
$course_slug = 'tennessee-grasslands-foxland';
$course_name = 'Tennessee Grasslands Golf & CC - Foxland';
      ...
      gtag('config', 'G-7VPNPCDTBP');
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Tennessee Grasslands Golf & CC - Foxland';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/tennessee-grasslands-foxland/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/tennessee-grasslands-foxland/${i}.webp`, '_blank');
...
<body>
    ...
    <section class="course-hero" style="
        height: 60vh; 
        background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('../images/courses/tennessee-grasslands-foxland/1.webp'); 
        background-size: cover; 
        background-position: center; 
        display: flex; 
        align-items: center; 
    ...
    ">
        <div class="course-hero-content" style="max-width: 800px; padding: 2rem;">
            <h1 style="font-size: 3.5rem; margin-bottom: 1rem; font-weight: 700;">Tennessee Grasslands - Foxland</h1>
            <p style="font-size: 1.3rem; margin-bottom: 2rem; opacity: 0.9;">Bill Bergin Design • Gallatin, Tennessee</p>
    ...
    <section class="course-details" style="padding: 4rem 0;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="course-info-grid" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 2rem; margin-bottom: 4rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-specs single-column" style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
                        ...
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">7,171</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=1445+Foxland+Boulevard,+Gallatin,+TN+37066&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                            ...
                            title="Tennessee Grasslands Foxland Course Location">
                        </iframe>
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=1445+Foxland+Boulevard,+Gallatin,+TN+37066" 
                               target="_blank" 
            ...
            <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); margin-bottom: 4rem;">
                <h3 style="color: #2c5234; margin-bottom: 1rem; font-size: 1.5rem;"><i class="fas fa-golf-ball"></i> About Tennessee Grasslands - Foxland Course</h3>
                <p>The Foxland Course at Tennessee Grasslands Golf & Country Club stands as the crown jewel of luxury golf north of Nashville, designed by acclaimed architect Bill Bergin and opened in 2007. This championship masterpiece stretches an impressive 7,171 yards from the championship tees with a par of 72, representing the ultimate expression of elegance and challenge in a spectacular lakeside setting on Old Hickory Lake.</p>
                
                <br>
                
                <p>Bergin's sophisticated design showcases premium TifEagle Ultradwarf Bermuda greens known for their lightning-fast speeds and perfect putting surfaces, complemented by pristine Cavalier Zoysia fairways and strategically placed 419 Hybrid Bermuda roughs. With a demanding course rating of 74.6 and slope of 134 from the championship tees, Foxland offers nine tee options that provide appropriate challenges for golfers of all abilities while maintaining tournament-level conditioning throughout the year.</p>
                
                <br>
                
                <p>The course exemplifies uncompromised maintenance standards, featuring nine daily variations of hole locations that ensure each round presents fresh strategic challenges for members. Foxland's longer and more demanding layout compared to its sister course Fairvue creates a stern test that rewards precision shot-making and strategic course management, while the natural beauty of the Old Hickory Lake setting provides a breathtaking backdrop for every round.</p>
                
                <br>
                
                <p>As the newer addition to Tennessee Grasslands' luxury golf offerings, the Foxland Course combines championship-caliber golf with the club's comprehensive amenity package including lakeside pools, state-of-the-art fitness facilities, racquet sports, and exquisite dining options. This commitment to excellence has established Foxland as one of Middle Tennessee's most challenging and prestigious golf experiences, where members enjoy world-class golf in an atmosphere of unparalleled luxury and refined hospitality.</p>
            </div>
    ...
    <section class="photo-gallery">
        <div class="container">
            <div class="section-header">
                ...
                <p>Experience the beauty of Tennessee Grasslands - Foxland</p>
            </div>
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../images/courses/tennessee-grasslands-foxland/1.webp" alt="Tennessee Grasslands Golf & CC - Foxland Gallatin, TN - Aerial view of championship 18-hole golf course showing signature holes and clubhouse facilities" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/tennessee-grasslands-foxland/2.webp" alt="Tennessee Grasslands Golf & CC - Foxland Gallatin TN - Panoramic fairway view hole 12 with strategic bunkers and mature trees" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/tennessee-grasslands-foxland/3.webp" alt="Tennessee Grasslands Golf & CC - Foxland Tennessee - Championship golf course layout showing championship layout and natural terrain" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
            </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            ...
                            <textarea name="comment_text" id="comment_text" rows="4" required 
                                      ...
                                      placeholder="Share your experience playing at Tennessee Grasslands - Foxland Course..."></textarea>
                        </div>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://tennesseegolfcourses.com/courses/tennessee-grasslands-foxland'); ?>" target="_blank" class="share-button facebook" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #1877f2; color: white;">
                        <i class="fab fa-facebook-f"></i> Share on Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out Tennessee Grasslands Foxland in designed championship golf course in Gallatin, Tennessee'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/tennessee-grasslands-foxland'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out Tennessee Grasslands Foxland'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/tennessee-grasslands-foxland'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
