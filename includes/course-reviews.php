...
// Get CSRF protection if not already included
...
// Fetch initial reviews (5 most recent)
try {
    $stmt = $pdo->prepare("
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
        ...
        <?php else: ?>
            <div style="background: #f8f9fa; padding: 2rem; border-radius: 15px; text-align: center; margin-bottom: 3rem;">
                <p><a href="../login.php" style="color: #2c5234; font-weight: 600; text-decoration: none;">Log in</a> to share your review of <?php echo htmlspecialchars($course_name); ?></p>
            </div>
        <?php endif; ?>
