...
<body>
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                ...
                <div class="gallery-item" style="background-image: url('../images/courses/the-links-at-fox-meadows/5.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/the-links-at-fox-meadows/6.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/the-links-at-fox-meadows/7.webp');"></div>
            </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">The Links at Fox Meadows - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced The Links at Fox Meadows</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="fox-meadows-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play The Links at Fox Meadows?</h2>
                <p>Experience this historic Chic Adams design and Memphis's longest municipal course</p>
                <div class="booking-buttons">
                    <a href="https://fox.tenfore.golf/foxmeadows" class="btn-book">Book Tee Time</a>
                    <a href="tel:9016360932" class="btn-contact">Call Pro Shop</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/the-links-at-fox-meadows/${i}.webp')`;
    ...
    <script>
        // Interactive star rating functionality for The Links at Fox Meadows
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('fox-meadows-rating-stars');
            if (ratingContainer) {
