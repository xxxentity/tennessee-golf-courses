...
$course_data = [
    ...
    'description' => '18-hole championship golf course in Millington, TN. Naval Support Activity Mid-South facility with TifEagle Bermuda greens, 6,895 yards from gold tees, par 72.',
...
<head>
    ...
    <style>
        .course-hero {
            height: 60vh;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../images/courses/glen-eagle-golf-course/1.webp');
...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            <h1>Glen Eagle Golf Course</h1>
            <p>Championship Course • Millington, Tennessee</p>
        ...
        <div class="container">
            <div class="course-info-grid">
                <div class="course-info-card">
                    ...
                    <div class="course-specs single-column">
                        ...
                        <div class="spec-item">
                            ...
                            <span class="spec-value">6,895 (Gold Tees)</span>
                        </div>
                        <div class="spec-item">
                        ...
                        <div class="spec-item">
                            <span class="spec-label">Sand Traps:</span>
                ...
                <div class="course-info-card">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <div class="course-specs">
                            <div class="spec-item">
                                <span class="spec-label">Weekday (Mon-Fri):</span>
                                <span class="spec-value">$29</span>
                            </div>
                            <div class="spec-item">
                                <span class="spec-label">Weekend/Holiday (Sat-Sun):</span>
                                <span class="spec-value">$45</span>
                            </div>
                        </div>
                    </div>
                    <p style="font-size: 0.9rem; color: #666; margin-top: 1rem;">
                        <strong>Note:</strong> Open to MWR authorized patrons and general public. Rates subject to change.
                    </p>
                </div>
                ...
                <div class="course-info-card">
                    ...
                    <a href="mailto:GlenEagle@us.navy.mil" style="color: #4a7c59;">GlenEagle@us.navy.mil</a></p>
                    
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=Glen+Eagle+Golf+Course+Millington+TN&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                            ...
                            title="Glen Eagle Golf Course Location">
                        </iframe>
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=Glen+Eagle+Golf+Course+Millington+TN" 
                               target="_blank" 
            ...
            <!-- Course Description -->
            <div class="course-info-card">
                <h3><i class="fas fa-golf-ball"></i> About Glen Eagle Golf Course</h3>
                <p>Glen Eagle Golf Course is a distinguished 18-hole championship course located at Naval Support Activity Mid-South in Millington, Tennessee. Originally opened in 1957 and designed by Ault, Clark, & Associates, this course offers an exceptional golfing experience for both military personnel and the general public.</p>
                
                <br>
                
                <p>The course features a challenging 6,895-yard layout from the gold tees with a par of 72, incorporating multiple tee options to accommodate players of all skill levels. From the black tees, golfers face 6,435 yards with a course rating of 71.5 and slope of 139, while the blue tees offer 5,992 yards. The white tees provide a more approachable 5,013 yards for ladies with a course rating of 69.6.</p>
                
                <br>
                
                <p>Glen Eagle is known for its well-maintained TifEagle Bermuda greens, which provide consistent putting surfaces throughout the year. The course design includes 48 strategically placed sand traps that challenge golfers while maintaining fair play. The layout features a balanced composition with 4 par-3 holes, 10 par-4 holes, and 4 par-5 holes.</p>
                
                <br>
                
                <p>As part of the Navy MWR (Morale, Welfare, and Recreation) program, Glen Eagle Golf Course serves the military community while welcoming civilian players. The facility operates daily from 7 AM to 6 PM, including federal holidays, with first tee times beginning at 7:30 AM on weekdays and 7 AM on weekends.</p>
                
                <br>
                
                <p>The course features excellent practice facilities including a driving range, putting green, and a unique 140-yard practice hole. The pro shop stocks top golf brands including Titleist, Callaway, Puma, and FootJoy, while offering club rentals and repair services. PGA professionals are available for instruction, helping golfers improve their game in a supportive environment.</p>
                
                <br>
                
                <p>Glen Eagle Golf Course maintains a recommended pace of play of 4 hours and 15 minutes, ensuring an enjoyable experience for all players. The facility's commitment to physical fitness and leisure time for military personnel extends to providing quality recreational opportunities for the broader Millington community.</p>
            </div>
            ...
            <div class="course-info-card">
                ...
                <div class="amenities-grid">
                    ...
                    <div class="amenity-item">
                        ...
                        <span>TifEagle Bermuda Greens</span>
                    </div>
                    <div class="amenity-item">
                        <i class="fas fa-target"></i>
                        <span>140-Yard Practice Hole</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Glen Eagle Golf Course - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Glen Eagle Golf Course</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="glen-eagle-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play Glen Eagle Golf Course?</h2>
                <p>Book your tee time today at this championship course in Millington, Tennessee</p>
                <div class="booking-buttons">
                    <a href="https://myffr.navyaims.com/navyeast/gleneagle.html" target="_blank" rel="noopener noreferrer" class="btn-book">Book Tee Time</a>
                    <a href="tel:(901) 874-5168" class="btn-contact">Call Pro Shop</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Glen Eagle Golf Course';
                const location = 'Millington, TN';
                const locationShort = 'Millington TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/glen-eagle-golf-course/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
                galleryItem.onclick = () => window.open(`../images/courses/glen-eagle-golf-course/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Glen Eagle Golf Course
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('glen-eagle-rating-stars');
            if (ratingContainer) {
