...
<body>
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">The Country Club - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced The Country Club</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="country-club-rating-stars">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="comment_text" name="comment_text" rows="4" placeholder="Share your experience playing this prestigious course..." required></textarea>
                        </div>
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Interested in The Country Club?</h2>
                <p>Contact the club for membership information and learn about this prestigious East Tennessee golf destination</p>
                <div class="booking-buttons">
                    <a href="tel:(423) 586-1941" class="btn-book">Call (423) 586-1941</a>
                    <a href="mailto:events@the-countryclub.com" class="btn-contact">Email Club</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/the-country-club/${i}.webp')`;
                galleryItem.onclick = () => window.open(`../images/courses/the-country-club/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for The Country Club
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('country-club-rating-stars');
            if (ratingContainer) {
