...
<!-- #5 Course -->
                <div class="course-item" id="course-5">
                    ...
                    <img src="/images/reviews/top-5-golf-courses-tennessee/5.jpeg" alt="Fall Creek Falls State Park Golf Course" class="course-image">
...
<!-- #4 Course -->
                <div class="course-item" id="course-4">
                    ...
                    <img src="/images/reviews/top-5-golf-courses-tennessee/4.jpeg" alt="TPC Southwind Golf Course" class="course-image">
                    <div class="course-rating">
...
<!-- #3 Course -->
                <div class="course-item" id="course-3">
                    ...
                    <img src="/images/reviews/top-5-golf-courses-tennessee/3.jpeg" alt="The Golf Club of Tennessee" class="course-image">
                    <div class="course-rating">
                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
...
<!-- #2 Course -->
                <div class="course-item" id="course-2">
                    ...
                    <img src="/images/reviews/top-5-golf-courses-tennessee/2.jpeg" alt="Troubadour Golf & Field Club" class="course-image">
                    <div class="course-rating">
                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
...
<!-- #1 Course -->
                <div class="course-item" id="course-1">
                    ...
                    <img src="/images/reviews/top-5-golf-courses-tennessee/1.jpeg" alt="The Honors Course" class="course-image">
                    <div class="course-rating">
                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
