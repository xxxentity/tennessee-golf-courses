...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            ...
            <p>Gary Weller Design • Chattanooga, Tennessee</p>
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/brown-acres-golf-course/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brown-acres-golf-course/3.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brown-acres-golf-course/4.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brown-acres-golf-course/5.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brown-acres-golf-course/6.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/brown-acres-golf-course/7.webp');"></div>
            </div>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Brown Acres Golf Course</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="brown-acres-rating-stars">
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/brown-acres-golf-course/${i}.webp')`;
