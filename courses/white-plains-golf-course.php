        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="share-section" style="background: var(--bg-white); padding: 2rem; border-radius: 20px; box-shadow: var(--shadow-medium); text-align: center;">
                ...
                <div class="share-buttons" style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://tennesseegolfcourses.com/courses/white-plains-golf-course'); ?>" target="_blank" class="share-button facebook" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #1877f2; color: white;">
                        <i class="fab fa-facebook-f"></i> Share on Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Check out White Plains Golf Course in Cookeville, Tennessee'); ?>&url=<?php echo urlencode('https://tennesseegolfcourses.com/courses/white-plains-golf-course'); ?>" target="_blank" class="share-button twitter" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #000000; color: white;">
                        <strong style="font-size: 1.1rem;">𝕏</strong> Share on X
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode('Check out White Plains Golf Course'); ?>&body=<?php echo urlencode('I thought you might be interested in this golf course: https://tennesseegolfcourses.com/courses/white-plains-golf-course'); ?>" class="share-button email" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.8rem 1.5rem; border-radius: 50px; text-decoration: none; transition: all 0.3s ease; font-weight: 500; background: #6c757d; color: white;">
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">White Plains Golf Course - Cookeville, TN</h2>
                <button class="close" onclick="closeGallery()">&times;</button>
            </div>
            <div class="full-gallery-grid">
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/1.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/1.jpeg', '_blank')" title="White Plains Golf Course - Course Overview"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/2.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/2.jpeg', '_blank')" title="White Plains Golf Course - Fairway View"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/3.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/3.jpeg', '_blank')" title="White Plains Golf Course - Course Layout"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/4.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/4.jpeg', '_blank')" title="White Plains Golf Course - Hole 4"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/5.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/5.jpeg', '_blank')" title="White Plains Golf Course - Hole 5"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/6.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/6.jpeg', '_blank')" title="White Plains Golf Course - Hole 6"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/7.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/7.jpeg', '_blank')" title="White Plains Golf Course - Hole 7"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/8.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/8.jpeg', '_blank')" title="White Plains Golf Course - Hole 8"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/9.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/9.jpeg', '_blank')" title="White Plains Golf Course - Hole 9"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/10.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/10.jpeg', '_blank')" title="White Plains Golf Course - Hole 10"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/11.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/11.jpeg', '_blank')" title="White Plains Golf Course - Hole 11"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/12.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/12.jpeg', '_blank')" title="White Plains Golf Course - Hole 12"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/13.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/13.jpeg', '_blank')" title="White Plains Golf Course - Hole 13"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/14.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/14.jpeg', '_blank')" title="White Plains Golf Course - Hole 14"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/15.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/15.jpeg', '_blank')" title="White Plains Golf Course - Hole 15"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/16.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/16.jpeg', '_blank')" title="White Plains Golf Course - Hole 16"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/17.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/17.jpeg', '_blank')" title="White Plains Golf Course - Hole 17"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/18.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/18.jpeg', '_blank')" title="White Plains Golf Course - Hole 18"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/19.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/19.jpeg', '_blank')" title="White Plains Golf Course - Clubhouse"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/20.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/20.jpeg', '_blank')" title="White Plains Golf Course - Practice Facilities"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/21.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/21.jpeg', '_blank')" title="White Plains Golf Course - Pro Shop"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/22.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/22.jpeg', '_blank')" title="White Plains Golf Course - Driving Range"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/23.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/23.jpeg', '_blank')" title="White Plains Golf Course - Putting Green"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/24.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/24.jpeg', '_blank')" title="White Plains Golf Course - Course Scenic View"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/white-plains-golf-course/25.jpeg')" onclick="window.open('../images/courses/white-plains-golf-course/25.jpeg', '_blank')" title="White Plains Golf Course - Course Panoramic View"></div>
            </div>
        </div>
    </div>
