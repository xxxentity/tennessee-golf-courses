<?php
$pageTitle = "MacIntyre Weathers Moving Day Storm to Maintain BMW Championship Lead";
$pageDescription = "Robert MacIntyre overcomes hostile crowd and brutal pin placements to maintain four-shot lead over Scottie Scheffler after BMW Championship third round.";
$pageKeywords = "MacIntyre Weathers Moving Day Storm to Maintain BMW Championship Lead, golf, Tennessee golf, PGA Tour, golf news";
$ogImage = "https://tennesseegolfcourses.com/images/news/macintyre-weathers-moving-day-storm-maintains-bmw-championship-lead/main.webp";
...
<main class="news-article">
    <div class="article-header">
        <div class="breadcrumb">
            <a href="/">Home</a> &rsaquo; <a href="/news">Golf News</a> &rsaquo; MacIntyre Weathers Moving Day Storm to Maintain BMW Champion...
        </div>

        <h1>MacIntyre Weathers Moving Day Storm to Maintain BMW Championship Lead</h1>
        ...
        <div class="article-meta">
            <div class="author-info">
                ...
                <div class="author-details">
                    ...
                    <span class="publish-date">August 16, 2025</span>
                </div>
            </div>
    ...
    <div class="article-image">
        <img src="/images/news/macintyre-weathers-moving-day-storm-maintains-bmw-championship-lead/main.webp" alt="Robert MacIntyre BMW Championship Third Round" class="featured-image">
        <p class="image-caption">Robert MacIntyre BMW Championship Third Round</p>
    </div>
    ...
    <div class="article-footer">
        ...
        <div class="share-section">
            ...
            <div class="share-buttons">
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://tennesseegolfcourses.com/news/macintyre-weathers-moving-day-storm-maintains-bmw-championship-lead" target="_blank" class="share-btn facebook"><i class="fab fa-facebook-f"></i> Share on Facebook</a>
                <a href="https://twitter.com/intent/tweet?text=MacIntyre+Weathers+Moving+Day+Storm+to+Maintain+BMW+Championship+Lead&url=https://tennesseegolfcourses.com/news/macintyre-weathers-moving-day-storm-maintains-bmw-championship-lead" target="_blank" class="share-btn twitter"><strong>𝕏</strong> Share on X</a>
                <a href="mailto:?subject=MacIntyre+Weathers+Moving+Day+Storm+to+Maintain+BMW+Championship+Lead&body=https://tennesseegolfcourses.com/news/macintyre-weathers-moving-day-storm-maintains-bmw-championship-lead" class="share-btn email"><i class="far fa-envelope"></i> Share via Email</a>
            </div>
        </div>
    </div>
</main>
