...
<head>
    ...
    <meta name="description" content="Greystone Golf Course - Mark McCumber championship design in Dickson, TN. 7,046 yards featuring signature island green and Tennessee State Open host venue.">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-specs single-column" style="display: grid; grid-template-columns: 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <span class="spec-value" style="font-weight: 700; color: #2c5234;">1 Greystone Drive</span>
                        </div>
                        <div class="spec-item" style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://maps.google.com/maps?q=1+Greystone+Drive,+Dickson,+TN+37055&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                            width="100%" 
                            height="200" 
                        ...
                        <div style="margin-top: 0.5rem; text-align: center;">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=1+Greystone+Drive,+Dickson,+TN+37055" 
                               target="_blank" 
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/greystone-golf-course/1.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/greystone-golf-course/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/greystone-golf-course/3.webp');"></div>
            </div>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/greystone-golf-course/${i}.webp')`;
                galleryItem.onclick = () => window.open(`../images/courses/greystone-golf-course/${i}.webp`, '_blank');
