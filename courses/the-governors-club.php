            ...
            <div class="course-info-grid">
                ...
                <div class="course-info-card">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=1500+Governors+Club+Drive,+Brentwood,+TN+37027" 
                            width="100%" 
                            height="200" 
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">The Governors Club - Complete Photo Gallery</h2>
