...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            ...
            <p>Donald Ross Design • Memphis, Tennessee</p>
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/memphis-country-club/2.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/memphis-country-club/3.webp');"></div>
                <div class="gallery-item" style="background-image: url('../images/courses/memphis-country-club/4.webp');"></div>
            </div>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Memphis Country Club</p>
            </div>
                ...
                <div class="review-form">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="comment_text" id="comment_text" placeholder="Share your experience at Memphis Country Club..." required></textarea>
                        </div>
            ...
            <?php else: ?>
                <div class="login-prompt">
                    <p>Please log in to leave a review of Memphis Country Club.</p>
