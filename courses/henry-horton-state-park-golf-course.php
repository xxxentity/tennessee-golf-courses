...
<body>
    ...
    <section class="course-hero">
        <div class="course-hero-content">
            ...
            <p>Bob Cupp Design • Chapel Hill, Tennessee</p>
        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="../images/courses/henry-horton-state-park-golf-course/2.webp" alt="Henry Horton State Park Golf Course Chapel Hill TN - Panoramic fairway view hole 12 with strategic bunkers and mature trees" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/henry-horton-state-park-golf-course/3.webp" alt="Henry Horton State Park Golf Course Tennessee - Championship golf course layout showing championship layout and natural terrain" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
                <div class="gallery-item">
                    <img src="../images/courses/henry-horton-state-park-golf-course/4.webp" alt="Henry Horton State Park Golf Course Chapel Hill TN - Championship golf course entrance with professional landscaping and signage" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">
                </div>
            </div>
    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'Henry Horton State Park Golf Course';
                const location = 'Chapel Hill, TN';
                const locationShort = 'Chapel Hill TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/henry-horton-state-park-golf-course/${i}.webp" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
