...
/**
 * Course Weather Data
 * Contains coordinates and location information for all Tennessee golf courses
 * Used to fetch location-specific weather for individual course pages
 */
...
$courseWeatherData = [
    ...
    'lookout-mountain-club' => [
        ...
        'state' => 'GA',  // Note: This is in Georgia
 ...
 * @param string $slug The course slug from the URL
 * @return array|null Returns course weather data or null if not found
 */
function getCourseWeatherData($slug) {
    global $courseWeatherData;
    return isset($courseWeatherData[$slug]) ? $courseWeatherData[$slug] : null;
}
?>