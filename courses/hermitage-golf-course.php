            ...
            <div class="course-info-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 3rem; margin-bottom: 4rem;">
                ...
                <div class="course-info-card" style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=3939+Old+Hickory+Blvd,+Old+Hickory,+TN+37138" 
                            width="100%" 
                            height="200" 
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" style="background-image: url('../images/courses/hermitage-golf-course/1.jpeg');"></div>
