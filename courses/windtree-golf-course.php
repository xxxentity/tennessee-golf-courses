    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Windtree Golf Course Photo Gallery</h2>
                <button class="close" onclick="closeGallery()">&times;</button>
            </div>
            <div class="full-gallery-grid">
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/1.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/2.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/3.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/4.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/5.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/6.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/7.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/8.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/9.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/10.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/11.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/12.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/13.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/14.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/15.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/16.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/17.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/18.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/19.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/20.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/21.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/22.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/23.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/24.jpeg');"></div>
                <div class="full-gallery-item" style="background-image: url('../images/courses/windtree-golf-course/25.jpeg');"></div>
            </div>
        </div>
    </div>
