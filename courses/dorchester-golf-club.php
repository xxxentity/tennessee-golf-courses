...
<body>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced Dorchester Golf Club</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="dorchester-rating-stars">
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/dorchester-golf-club/${i}.webp')`;
    ...
    <script>
        // Interactive star rating functionality for Dorchester Golf Club
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('dorchester-rating-stars');
            if (ratingContainer) {
    ...
    <script>
        // Initialize course-specific weather for Dorchester Golf Club
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof initializeCourseWeather === 'function') {
                initializeCourseWeather('dorchester-golf-club');
            }
        });
    </script>
</body>
