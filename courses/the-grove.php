    ...
    <script>
        ...
        function openGallery() {
            ...
            function getAltText(imageIndex) {
                const courseName = 'The Grove';
                const location = 'College Grove, TN';
                const locationShort = 'College Grove TN';
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.innerHTML = `<img src="../images/courses/the-grove/${i}.jpeg" alt="${getAltText(i)}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;">`;
