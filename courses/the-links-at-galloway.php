...
<head>
    ...
    <title>The Links at Galloway - Tennessee Golf Courses</title>
    <meta name="description" content="The Links at Galloway - Kevin Tucker designed municipal course in Memphis, TN. Historic Galloway Golf Course featuring 6,013-yard Par 70 layout with challenging greens.">
...
<body>
            ...
            <div class="course-info-grid">
                ...
                <div class="course-info-card">
                    ...
                    <div class="course-map" style="margin-top: 1.5rem;">
                        <iframe 
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBokugMWbWJvSkdv3Op_d7MKs8eEGIhkCw&q=3815+Walnut+Grove+Road,+Memphis,+TN+38111" 
                            width="100%" 
                            height="200" 
    ...
    <div id="galleryModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">The Links at Galloway - Complete Photo Gallery</h2>
    ...
    <section class="reviews-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Read reviews from golfers who have experienced The Links at Galloway</p>
            </div>
                ...
                <div class="comment-form-container">
                    ...
                    <form method="POST" class="comment-form">
                        <div class="form-group">
                            ...
                            <div class="star-rating" id="galloway-rating-stars">
    ...
    <section class="booking-section">
        <div class="container">
            <div class="booking-content">
                <h2>Ready to Play The Links at Galloway?</h2>
                <p>Book your tee time today and experience this historic Memphis golf course</p>
                <div class="booking-buttons">
                    <a href="tel:+19013620232" class="btn-book">Call for Tee Time</a>
                    <a href="https://memphispubliclinks.com/galloway/" target="_blank" rel="noopener noreferrer" class="btn-contact">Visit Website</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openGallery() {
            ...
            for (let i = 1; i <= 25; i++) {
                ...
                galleryItem.style.backgroundImage = `url('../images/courses/the-links-at-galloway/${i}.webp')`;
                galleryItem.onclick = () => window.open(`../images/courses/the-links-at-galloway/${i}.webp`, '_blank');
    ...
    <script>
        // Interactive star rating functionality for Galloway
        document.addEventListener('DOMContentLoaded', function() {
            const ratingContainer = document.getElementById('galloway-rating-stars');
            if (ratingContainer) {
