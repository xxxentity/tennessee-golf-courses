    ...
    <section class="course-details">
        <div class="container">
            <div class="course-info-grid">
                ...
                <div class="course-info-card">
                    <h3><i class="fas fa-dollar-sign"></i> Course Ratings & Fees</h3>
                    <div style="margin-bottom: 1.5rem;">
                        <h4 style="color: #2c5234; margin-bottom: 0.5rem;">Black Tees</h4>
                        <div class="course-specs">
                            <div class="spec-item">
                                <span class="spec-label">Rating/Slope:</span>
                                <span class="spec-value">75.2 / 139</span>
                            </div>
                            <div class="spec-item">
                                <span class="spec-label">Yardage:</span>
                                <span class="spec-value">7,393</span>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <h4 style="color: #2c5234; margin-bottom: 0.5rem;">Orange Tees</h4>
                        <div class="course-specs">
                            <div class="spec-item">
                                <span class="spec-label">Rating/Slope:</span>
                                <span class="spec-value">73.2 / 134</span>
                            </div>
                            <div class="spec-item">
                                <span class="spec-label">Yardage:</span>
                                <span class="spec-value">6,936</span>
                            </div>
                        </div>
                    </div>
                    <div style="margin-top: 2rem; padding-top: 1rem; border-top: 1px solid #e5e7eb;">
                        <p style="font-size: 1.1rem; color: #2c5234; font-weight: 600; text-align: center;">
                            <i class="fas fa-phone"></i> Call for Current Pricing
                        </p>
                    </div>
                </div>
